...
export default function Login() {
    ...
    const demoCredentials = [
        { role: 'Admin', email: 'admin@civiclens.gov', password: 'admin123', icon: '👑' },
        { role: 'Officer', email: 'officer1@civiclens.gov', password: 'officer123', icon: '👮' },
        { role: 'Citizen', email: 'citizen@example.com', password: 'citizen123', icon: '👤' },
    ];
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {demoCredentials.map((cred) => (
                                <button
                                    ...
                                    className="p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 transition-all text-center group"
                                >
                                    <div className="text-2xl mb-1 group-hover:scale-110 transition-transform">
                                        {cred.icon}
                                    </div>
                                    <div className="text-xs text-gray-400">{cred.role}</div>
                                </button>
                            ))}
                        </div>
                    </div>
